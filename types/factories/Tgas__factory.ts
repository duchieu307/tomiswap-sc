...
import type { Tgas } from "../Tgas";

export class Tgas__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<Tgas> {
    return super.deploy(overrides || {}) as Promise<Tgas>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): Tgas {
    return super.attach(address) as Tgas;
  }
  connect(signer: Signer): Tgas__factory {
    return super.connect(signer) as Tgas__factory;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Tgas {
    return new Contract(address, _abi, signerOrProvider) as Tgas;
  }
}
