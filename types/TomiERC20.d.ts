...
interface TomiERC20Interface extends ethers.utils.Interface {
  functions: {
    "TokenSignature()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TokenSignature",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class TomiERC20 extends Contract {
  ...
  interface: TomiERC20Interface;

  functions: {
    TokenSignature(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  TokenSignature(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    TokenSignature(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    TokenSignature(overrides?: CallOverrides): Promise<PopulatedTransaction>;
